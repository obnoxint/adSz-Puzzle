...
1. Eine Konfigurationsdatei mit der Dateinamenerweiterung _.properties_.
...
Dateinamenerweiterung _.properties_. Der Name der Datei sollte keine Leerzeichen
enthalten.
...
## Unterstützung
Wenn Sie ein Problem melden oder einen Verbessungsvorschlag einreichen möchten,
